...
class DefaultController extends AbstractController
{
    ...
    /**
     * @Route("/api/entity", name="entity")
     * @return \Symfony\Component\HttpFoundation\JsonResponse
     */
    public function getEntity(TestEntityRepository $testEntityRepository)
    {
        $entityQuery = $testEntityRepository->findOneBy([
            'id' => 1
        ]);
        $entity = [
            [
                'id' => $entityQuery->getId(),
                'name' => $entityQuery->getName(),
                'date' => $entityQuery->getDate()
            ]
        ];
